...
namespace PACMAN {
    namespace MODEL {
        ...
        public:
            ...
            unsigned int get_action_count(unsigned int player_index) const;
            Action get_action_along_direction(unsigned int player_index, Direction::Type direction) const;
            bool is_trivial_round() const;
